...
const PlayerContent: React.FC<PlayerContentProps> = ({ song, songUrl }) => {
    ...
    const onPlayNext = () => {
        ...
        if (!nextSong) return player.setId(player.ids[0]);  // loop the playlist if at the end
    ...
    const onPlayPrevious = () => {
        ...
        if (!previousSong) return player.setId(player.ids[player.ids.length - 1]);  // loop the playlist if at the end
